...
public class GUI_Validator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CardCodePasswordField.setBackground(new java.awt.Color(51, 51, 51));
        ...
        jPanel1.add(CardCodePasswordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 210, 90, -1));

        jLabel5.setFont(new java.awt.Font("Roboto Light", 2, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(51, 51, 51));
        jLabel5.setText("Ingrese su número de cuenta:");
    ...
    private void PasswordFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasswordFieldActionPerformed
        ...
        try{
            if (matchvalidator2){
                ...
                this.setVisible(false);
                GUI_Error pError = new GUI_Error("Incorrect data.", 0);
                pError.setVisible(true);
            }
