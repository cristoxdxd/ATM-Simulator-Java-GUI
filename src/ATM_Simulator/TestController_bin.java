 ...
 */
public class TestController_bin {
    public static void main(String[] args) throws NoSuchAlgorithmException {
        System.out.println("\tTo test Binary\n--> Cristopher Herrera");
        String FileRoute = "ClientsBinary.data";
        int option = 0;
        final int exit = 7;
        do{
            option = StandarReading.readInt("\n\tFuture Promises School"
                    + "\n1. Show Students List"
                    + "\n2. Show Students (one-by-one)"
                    + "\n3. Add a student"
                    + "\n4. Find data"
                    + "\n5. Update a student (by List Number)"
                    + "\n6. Remove a student (by List Number)"
            ...
            switch(option){
                ...
                case 4:
                    ...
                    FilesManager_bin.findinFile(searchWord, FileRoute);
                    break;
                case 5:
